      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-lg p-8 md:p-12 text-center">
        ...
        <div className="relative inline-block mb-8">
          <div className="absolute inset-0 flex items-center justify-center z-0">
            <div className="w-32 h-32 bg-green-100 rounded-full animate-ping opacity-50"></div>
          </div>
          <div className="relative w-24 h-24 bg-green-500 rounded-full flex items-center justify-center text-white mx-auto">
            {" "}
        ...
        <div className="mb-8 space-y-3">
          ...
          <p className="text-base md:text-lg text-brand-gray-dark leading-relaxed">
            {" "}
            Thanks for shopping! We'll send you an email when your order ships.{" "}
          </p>
        </div>
